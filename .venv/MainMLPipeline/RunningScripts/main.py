...
TRAINING_CONFIG = {
    ...
    "grid_search": {
        ...
        "C_grid": [  0.003, 0.01, 0.03, 1.3,0.1, 0.3, 0.5, 0.7, 0.9, 1.0],  # Regularization C values 
    },
...
# %%
    ...
    if CreateSubPlots:
        slices = eval_slices(
            post.reset_index(drop=True), Y_post, y_prob_post, classes, args.multilabel, plots_dir=graphs_dir, do_plots=True, max_groups_per_col=None
        )
